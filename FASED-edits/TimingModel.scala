...
""",
  ...
  if (cfg.useLLCModel) {
    ...
    // NEW CONNECTIONS
    //llc_model.io.tNasti <> io.tNasti
    llc_model.io.tNastiRChannelFire := io.tNasti.r.fire
    llc_model.io.tNastiBChannelFire := io.tNasti.b.fire
    llc_model.io.tNastiRChannel := io.tNasti.r.bits
    llc_model.io.tNastiBChannel := io.tNasti.b.bits
    llc_model.io.pendingReadsFull := pendingReads.full
    llc_model.io.pendingAWReqFull := pendingAWReq.full
    llc_model.io.pendingWReqFull := pendingWReq.full
  } else {
